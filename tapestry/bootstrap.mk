...
TAPESTRY_ROOT      := $(patsubst %/,%,$(dir $(MAKEFILE_PATH_ROOT)))
...
TAPESTRY_INSTALL ?= $(TAPESTRY_ROOT)
SRC     ?= $(SRC_ROOT)
DBG     ?=
...
all: $(TAPESTRY_BIN)
	...
	@SRC=$(SRC) TAPESTRY_INSTALL=$(TAPESTRY_INSTALL) DBG=$(DBG) $(TAPESTRY_BIN) $(TAPESTRY_FILE)
